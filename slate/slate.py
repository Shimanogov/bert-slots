...
from slate.dvae import dVAE
from slate.slot_attn import SlotAttentionEncoder
from slate.transformer import PositionalEncoding, TransformerDecoder
...
class SLATE(nn.Module):
    def __init__(self, args):
        ...
        self.dvae = dVAE(args.vocab_size, 3)
